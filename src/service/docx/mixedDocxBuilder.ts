...
import { buildKeyValueTable, formatDateUS, formatMonthYear, goldDivider } from "./builders/utils.js";
...
export async function generateMixedDocx(reportData: any): Promise<Buffer> {
  ...
  const t = {
    en: {
      ...
      purposeBody: (client: string) => `The purpose of this appraisal report is to provide an opinion of value of the subject for internal consideration and to assist ${client} and the specified personnel within their corporation in establishing a current Orderly Liquidation Value (OLV) for financial considerations. This report is not intended to be used for any other purpose. Based on the purpose of the appraisal, we have valued the subject assets under the premise of OLV.`,
      identHeading: 'Identification of Assets Appraised',
      identBody: 'As set out in the attached sections of this report, the assets appraised within this engagement include: Construction & Transportation Equipment.',
      scopeHeading: 'Scope of Work',
      scopeIntro: 'Valuation process and methodology — the appraiser employed the following procedures to determine the value conclusions rendered herein:',
      scopeBullet1: 'Review and analysis of asset records and other informational materials.',
      scopeBullet2: 'Inspection and analysis of assets and equipment at the client location(s).',
      observationsHeading: 'Observations and Comments',
      observationsBody: 'Available data and market comparables utilized were up to 120 days old. Increased weighting was given to recent regionally specific comparables when available.',
      intendedHeading: 'Intended Users',
      intendedBody: 'This appraisal is not intended to be reproduced or used for any purpose other than that outlined in this appraisal and is for the internal use of the client.',
      valueTermHeading: 'Value Terminology',
      valueOLVHeading: 'Orderly Liquidation Value (OLV)',
      valueOLVBody: (ccy: string) => `The estimated amount, expressed in terms of cash in ${ccy}, that could typically be realized from a liquidation sale, with the seller being compelled to sell on an 'as-is condition, where-is location' basis, as of a specific date and over a 120 day period.`,
      valueOLVScenarioBody: 'For the purpose of this appraisal, we have considered a properly advertised and professionally managed privately negotiated sale scenario, over a period of 120 days, during normal business operations or while winding down operations, with the buyer responsible for dismantling and removal at their own risk and expense.',
      definitionsHeading: 'Definitions and Obsolescence',
      physicalDetHeading: 'Physical Deterioration',
      physicalDetBody: 'A form of depreciation where the loss in value or usefulness of a property is due to the using up or expiration of its useful life caused by wear and tear, deterioration, exposure to various elements, physical stresses, and similar factors.',
      functionalObsHeading: 'Functional Obsolescence',
      functionalObsBody: 'A form of depreciation in which the loss in value or usefulness is caused by inefficiencies or inadequacies of the asset itself when compared to a more efficient or less costly replacement that newer technology has developed.',
      economicObsHeading: 'Economic Obsolescence',
      economicObsBody: 'A form of depreciation or loss in value caused by external factors such as industry economics, availability of financing, legislation, increased cost of inputs without offsetting price increases, reduced demand, increased competition, inflation, or high interest rates.',
      depreciationHeading: 'Depreciation',
      depreciationBody: 'The actual loss in value or worth of a property from all causes including physical deterioration, functional obsolescence, and economic obsolescence.',
      limitingHeading: 'Limiting Conditions and Critical Assumptions',
      assetCondHeading: 'Asset Conditions',
      assetCondBody: 'Certain information was provided to the appraiser regarding repairs, engines, undercarriages, and upgrades. These were considered when appraising and comparing the subject assets with market comparables. Some assets may have extended warranties.',
      titleAssetsHeading: 'Title to the Assets',
      titleAssetsBody: 'No investigation has been made of, and no responsibility is assumed for, legal matters including title or encumbrances. Title is assumed to be good and marketable unless otherwise stated.',
      responsibleOwnHeading: 'Responsible Ownership',
      responsibleOwnBody: 'It is assumed that the subject assets are under responsible ownership and competent management.',
      statedPurposeHeading: 'Stated Purpose',
      statedPurposeBody: 'This appraisal and report have been made only for the stated purpose and cannot be used for any other purpose.',
      valuationDateHeading: 'Valuation Date',
      valuationDateBody: (dateStr: string, ccy: string) => `The valuation date is ${dateStr || 'the effective date'}; values are in ${ccy} as of that date.`,
      inspectionHeading: 'Inspection',
      inspectionBody: (monthStr?: string) => `The subject assets were inspected ${monthStr ? `in ${monthStr}` : 'as noted in the report'}. When the inspection date differs from the valuation date, no material change is assumed unless otherwise stated.`,
      hazardousHeading: 'Hazardous Substances',
      hazardousBody: 'No allowance has been made for potential environmental problems. The value estimate assumes full compliance with applicable regulations and the absence of hazardous materials unless stated.',
      changeMarketHeading: 'Change in Market Conditions',
      changeMarketBody: 'We are not responsible for changes in market conditions after the valuation date and have no obligation to revise the report for subsequent events.',
      unexpectedHeading: 'Unexpected Conditions',
      unexpectedBody: 'It is assumed there are no hidden or non-apparent conditions that would affect value. No responsibility is assumed for such conditions.',
      companySubjectHeading: 'Company, Subject Asset Description',
      companyDiscussionHeading: 'Company Discussion',
      companyDiscussionBody: (client: string) => `${client} operates across multiple divisions and locations. The subject engagement focuses on relevant operating divisions connected to the subject assets.`,
      subjectAssetsHeading: 'Subject Assets Discussion',
      subjectAssetsBody: 'The major subject assets include Construction and Transportation equipment. Overall, these were found to be in good to excellent condition, subject to the assumptions and limiting conditions.',
      approachesHeading: 'Approaches to Value',
      costApproachHeading: 'Cost Approach',
      costApproachBody: 'A set of procedures in which an appraiser derives a value indication by estimating the current cost to reproduce or replace the assets, deducting for all depreciation, including physical deterioration, functional obsolescence, and external or economic obsolescence.',
      marketApproachHeading: 'Sales Comparison (Market) Approach',
      marketApproachBody: 'A set of procedures in which an appraiser derives a value indication by comparing the assets being appraised with similar assets that have been sold recently and making appropriate adjustments.',
      incomeApproachHeading: 'Income Capitalization Approach',
      incomeApproachBody: 'A set of procedures in which an appraiser derives a value indication for income-producing assets by converting anticipated benefits into value via capitalization or discounting of cash flows.',
      alternateUseHeading: 'Alternate Use & Appropriate Market Approach',
      alternateUseBody: 'We considered the appropriate market and level of trade, availability of reliable market data, market conditions as of the valuation date, and a marketing period consistent with the intended use identified.',
      reconciliationHeading: 'Reconciliation of Valuation Approaches',
      reconciliationBody: 'The Cost and Market approaches were utilized and reconciled. The Income approach was considered but not applied for reasons discussed within this report.',
      hbuHeading: 'Highest and Best Use',
      hbuBody: 'We considered the highest and best use of the subject assets, including what is legally permissible, physically possible, financially feasible, and maximally productive.',
      valProcessHeading: 'Valuation Process and Methodology',
      dataCollectionHeading: 'Data Collection',
      dataCollectionBody: (monthStr?: string) => `Site visits were performed ${monthStr ? `in ${monthStr}` : 'as required'}. Discussions with client personnel informed our understanding of operations and maintenance policies.`,
      valuationProcessHeading2: 'Valuation Process',
      valuationProcessBody: 'We considered the income, sales comparison, and cost approaches and concluded on the appropriate methods given the asset types and available data.',
      researchMethodHeading: 'Research Methodology',
      researchMethodBody: 'Research included auction and dealer results, OEM data, used equipment marketplaces, and current market/geographic conditions for similar assets.',
      codeEthicsHeading: 'Code of Ethics',
      competencyHeading: 'Competency',
      competencyBody: 'The appraiser has the appropriate knowledge and experience to develop credible results for the purpose and use outlined in this report.',
      confidentialityHeading: 'Confidentiality',
      confidentialityBody: 'This report and supporting file documentation are confidential. Distribution to parties other than the client requires prior written consent.',
      experienceHeading: 'EXPERIENCE',
      experienceBody1: 'McDougall Auctioneers Ltd. is one of Western Canada’s leading full-service auction and valuation firms, with over 40 years of experience in marketing, selling, and appraising assets across a diverse range of industries. Headquartered in Saskatchewan and operating throughout Canada and the United States, McDougall Auctioneers has built a reputation for impartial, defensible valuations that meet or exceed industry and regulatory standards.',
      experienceBody2: 'Our appraisal team combines Certified Personal Property Appraisers, experienced auctioneers, and subject-matter specialists who have inspected and valued tens of thousands of assets annually. We deliver comprehensive appraisals for equipment, vehicles, industrial machinery, agricultural assets, and business inventories, using recognised methodologies such as the Market Approach, Cost Approach, and, where applicable, the Income Approach. All assignments are performed in compliance with the Uniform Standards of Professional Appraisal Practice (USPAP) and relevant Canadian appraisal guidelines.',
      experienceBody3: 'McDougall’s extensive auction platform provides us with current, real-world market data on comparable sales. This proprietary database allows us to support our valuations with up-to-date evidence of pricing trends, demand fluctuations, and liquidation values. Whether for insurance, financing, litigation, or internal asset management, our appraisals provide accurate, timely, and defensible fair market values.',
      experienceBody4: 'Our industry experience spans construction, transportation, agriculture, heavy equipment, manufacturing, and retail inventories. We are frequently engaged by banks, insolvency professionals, legal counsel, government agencies, and private owners to appraise assets ranging from single high-value machines to large, multi-site fleets. This depth of experience ensures that every McDougall appraisal assignment is approached with professionalism, objectivity, and an understanding of how market conditions translate into asset value. Clients can rely on McDougall Auctioneers for clear, well-documented reports that withstand scrutiny from lenders, courts, insurers, and auditors alike.',
    },
    fr: {
      ...
      hbuBody: "Nous avons considéré l’usage optimal des actifs, y compris ce qui est légalement permis, physiquement possible, financièrement réalisable et maximisant la valeur.",
      ...
      researchMethodBody: "La recherche a inclus des résultats d’enchères et de concessionnaires, des données d’OEM, des places de marché d’équipements d’occasion et les conditions de marché/géographiques actuelles pour des actifs similaires.",
  ...
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.scopeBullet1, bullet: { level: 0 } })
  );
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.scopeBullet2, bullet: { level: 0 } })
  );
  ...
  // Intended Users
  children.push(
    new Paragraph({ text: t.intendedHeading, heading: HeadingLevel.HEADING_1, spacing: { before: 200, after: 60 } })
  );
  children.push(goldDivider());
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.intendedBody })
  );

  // Value Terminology — OLV
  children.push(
    new Paragraph({ text: t.valueTermHeading, heading: HeadingLevel.HEADING_1, spacing: { before: 200, after: 60 } })
  );
  children.push(goldDivider());
  children.push(
    new Paragraph({ text: t.valueOLVHeading, heading: HeadingLevel.HEADING_2, spacing: { after: 40 } })
  );
  children.push(
  ...
  children.push(
    new Paragraph({ text: t.definitionsHeading, heading: HeadingLevel.HEADING_1, pageBreakBefore: true, spacing: { after: 80 } })
  );
  children.push(goldDivider());
  children.push(new Paragraph({ text: t.physicalDetHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.physicalDetBody })
  );
  children.push(new Paragraph({ text: t.functionalObsHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.functionalObsBody })
  );
  children.push(new Paragraph({ text: t.economicObsHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.economicObsBody })
  );
  children.push(new Paragraph({ text: t.depreciationHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
  ...
  children.push(
    new Paragraph({ text: t.limitingHeading, heading: HeadingLevel.HEADING_1, pageBreakBefore: true, spacing: { after: 80 } })
  );
  children.push(goldDivider());
  children.push(new Paragraph({ text: t.assetCondHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.assetCondBody })
  );
  children.push(new Paragraph({ text: t.titleAssetsHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.titleAssetsBody })
  );
  children.push(new Paragraph({ text: t.responsibleOwnHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.responsibleOwnBody })
  );
  children.push(new Paragraph({ text: t.statedPurposeHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.statedPurposeBody })
  );
  children.push(new Paragraph({ text: t.valuationDateHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.valuationDateBody(formatDateUS(reportData?.effective_date) || '', ccy) })
  );
  children.push(new Paragraph({ text: t.inspectionHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.inspectionBody(formatMonthYear(reportData?.inspection_date) || undefined) })
  );
  children.push(new Paragraph({ text: t.hazardousHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.hazardousBody })
  );
  children.push(new Paragraph({ text: t.changeMarketHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.changeMarketBody })
  );
  children.push(new Paragraph({ text: t.unexpectedHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.unexpectedBody })
  );

  // Company, Subject Asset Description
  children.push(
    new Paragraph({ text: t.companySubjectHeading, heading: HeadingLevel.HEADING_1, pageBreakBefore: true, spacing: { after: 80 } })
  );
  children.push(goldDivider());
  children.push(new Paragraph({ text: t.companyDiscussionHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.companyDiscussionBody(purposeClient) })
  );
  children.push(new Paragraph({ text: t.subjectAssetsHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
  ...
  // Approaches to Value
  children.push(
    new Paragraph({ text: t.approachesHeading, heading: HeadingLevel.HEADING_1, pageBreakBefore: true, spacing: { after: 80 } })
  );
  children.push(goldDivider());
  children.push(new Paragraph({ text: t.costApproachHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.costApproachBody })
  );
  children.push(new Paragraph({ text: t.marketApproachHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.marketApproachBody })
  );
  children.push(new Paragraph({ text: t.incomeApproachHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.incomeApproachBody })
  );
  children.push(new Paragraph({ text: t.alternateUseHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.alternateUseBody })
  );
  children.push(new Paragraph({ text: t.reconciliationHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.reconciliationBody })
  );
  children.push(new Paragraph({ text: t.hbuHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.hbuBody })
  );

  // Valuation Process and Methodology
  children.push(
    new Paragraph({ text: t.valProcessHeading, heading: HeadingLevel.HEADING_1, pageBreakBefore: true, spacing: { after: 80 } })
  );
  children.push(goldDivider());
  children.push(new Paragraph({ text: t.dataCollectionHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.dataCollectionBody(formatMonthYear(reportData?.inspection_date) || undefined) })
  );
  children.push(new Paragraph({ text: t.valuationProcessHeading2, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ style: "BodyLarge", text: t.valuationProcessBody })
  );
  children.push(new Paragraph({ text: t.researchMethodHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
  ...
  // Code of Ethics
  children.push(
    new Paragraph({ text: t.codeEthicsHeading, heading: HeadingLevel.HEADING_1, pageBreakBefore: true, spacing: { after: 80 } })
  );
  children.push(goldDivider());
  children.push(new Paragraph({ text: t.competencyHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
    new Paragraph({ text: t.competencyBody, style: "BodyLarge" })
  );
  children.push(new Paragraph({ text: t.confidentialityHeading, heading: HeadingLevel.HEADING_2 }));
  children.push(
  ...
  for (const gid of useGroupIds) {
    ...
    if (subMode === "per_item") {
      ...
      children.push(...(await buildPerPhotoTable(items, rootImageUrls, contentWidthTw, label, (reportData as any)?.currency)));
    } else {
      const pseudo = { ...reportData, lots: items };
