...
// Central list of allowed categories for both prompts and XLSX export.
// Note: Do NOT include "General Merchandise".
...
- quantity: number — Item count (Excel "Quantity" column), default 1 if unknown
 - categories: string — Choose EXACTLY ONE from allowedCategories: ${allowedCategories.map((c) => `"${c}"`).join(", ")}. Maps to Excel "Categories" column. If uncertain, pick the closest applicable category from this list. Do NOT invent new categories. Do NOT use "General Merchandise".
  ...
  "lots": [
    {
      ...
      "quantity": 1,
      "must_take": false,
      "categories": "Yard Care And Lawn Equipment / Lumber",
      "serial_number": null,
      "show_on_website": true,
